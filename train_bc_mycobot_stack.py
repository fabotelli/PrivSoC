...
dataset and the periodic in-flight eval target (eval_bc_mycobot_stack.py) differ.
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % args.eval_every == 0 or epoch == args.epochs:
            ...
            cmd = ["python3", "eval_bc_mycobot_stack.py", "--policy", snap,
